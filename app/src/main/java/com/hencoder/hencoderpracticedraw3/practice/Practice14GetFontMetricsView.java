...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d("Practice14 top is ",String.valueOf(fontMetrics.top));
        Log.d("Practice14 bottom is ",String.valueOf(fontMetrics.bottom));
        Log.d("Practice14 ascent is ",String.valueOf(fontMetrics.ascent));
        Log.d("Practice14 descent is ",String.valueOf(fontMetrics.descent));
        Log.d("Practice14 leading is ",String.valueOf(fontMetrics.leading));
        float height=Math.abs(fontMetrics.ascent)+fontMetrics.descent;
        int middle = bottom-top+Math.round(Math.abs(fontMetrics.ascent));
        Log.d("Practice14 middle is ",String.valueOf(middle));
