...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int middle1 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle1));
        canvas.drawText(text1, 100, middle1, paint2);

        paint2.getTextBounds(text2,0,text2.length(),bounds);
        Log.d("bounds is ",bounds.toString());
        int middle2 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle2));
        canvas.drawText(text2, 200, middle2, paint2);

        paint2.getTextBounds(text3,0,text3.length(),bounds);
        Log.d("bounds is ",bounds.toString());
        int middle3 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle3));
        canvas.drawText(text3, 300, middle3, paint2);

        paint2.getTextBounds(text4,0,text4.length(),bounds);
        Log.d("bounds is ",bounds.toString());
        int middle4 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle4));
        canvas.drawText(text4, 400, middle4, paint2);

        paint2.getTextBounds(text5,0,text5.length(),bounds);
        Log.d("bounds is ",bounds.toString());
        int middle5 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle5));
        canvas.drawText(text5, 500, middle5, paint2);

        paint2.getTextBounds(text6,0,text6.length(),bounds);
        Log.d("bounds is ",bounds.toString());
        int middle6 = bottom-(bottom-top -(bounds.bottom-bounds.top)) / 2;
        Log.d("middle is ",String.valueOf(middle6));
